    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mood_music.mood')),
            ],
        ),
        migrations.CreateModel(
            name='Song',
            fields=[
                ...
                ('mood', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mood_music.mood')),
                ('mood_playlist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mood_music.moodplaylist')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mood_music.mood')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mood_music.user')),
            ],
        ),
    ]
